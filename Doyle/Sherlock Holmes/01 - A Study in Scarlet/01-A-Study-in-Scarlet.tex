...
\hypersetup{ 
  ...
  pdftitle    = {Sherlock Holmes 1: A Study in Scarlet},
...
\lettrine[lines=2]{I}{n} the year 1878 I took my degree of Doctor of Medicine of the University
...
\lettrine[lines=2]{I}{} confess that I was considerably startled by this fresh proof of
...
\lettrine[lines=2]{I}{t} was one o'clock when we left No.\ 3, Lauriston Gardens. Sherlock
...
\lettrine[lines=2]{O}{ur} morning's exertions had been too much for my weak health, and
...
\lettrine[lines=2]{T}{he} papers next day were full of the {}``Brixton Mystery,'' as they
...
\lettrine[lines=2]{T}{he} intelligence with which Lestrade greeted us was so momentous and
...
roadway without any of those \textit{outr\'{e}} and sensational accompaniments
...
\lettrine[lines=2]{I}{n} the central portion of the great North American Continent there
...
There are swift-flowing rivers which dash through jagged ca\~{n}ons; and
...
\lettrine[lines=2]{T}{his} is not the place to commemorate the trials and privations endured
...
\lettrine[lines=2]{T}{hree} weeks had passed since Jefferson Hope and his comrades had departed
...
%
\begin{figure}[htbp]
\noindent \begin{center}\includegraphics[%
...
\lettrine[lines=2]{O}{n} the morning which followed his interview with the Mormon Prophet,
...
\lettrine[lines=2]{A}{ll} night their course lay through intricate defiles and over irregular
...
\textit{blas\'{e}} as they were in every detail of crime, appeared to
...
\lettrine[lines=2]{W}{e} had all been warned to appear before the magistrates upon the Thursday;
